...
// 	addListener: {
// 		(
// 			event: WebPlaybackErrors,
// 			callback: (d: IWebPlaybackError) => void
// 		): boolean;
// 		(
// 			event: WebPlaybackStates,
// 			callback: (d: IWebPlaybackState | null) => void
// 		): boolean;
// 		(
// 			event: WebPlaybackStatuses,
// 			callback: (d: IWebPlaybackReady) => void
// 		): boolean;
// 	};
